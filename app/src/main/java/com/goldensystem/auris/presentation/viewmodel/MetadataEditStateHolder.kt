...
import com.goldensystem.auris.data.media.ImageCacheManager
import com.goldensystem.auris.data.media.MetadataEditError
...
import com.goldensystem.auris.utils.FileDeletionUtils
    ...
    suspend fun saveMetadata(
        ...
        val finalCoverArtUpdate = if (coverArtUpdate == null) {
            val existingMetadata = try {
                 com.goldensystem.auris.data.media.AudioMetadataReader.read(java.io.File(song.path))
            } catch (e: Exception) {
                null
            }
