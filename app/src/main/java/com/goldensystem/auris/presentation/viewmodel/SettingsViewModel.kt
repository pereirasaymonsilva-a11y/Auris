...
import com.goldensystem.auris.data.backup.BackupManager
import com.goldensystem.auris.data.backup.model.BackupSection
import com.goldensystem.auris.data.backup.model.BackupOperationType
import com.goldensystem.auris.data.backup.model.BackupTransferProgressUpdate
import com.goldensystem.auris.data.backup.model.BackupHistoryEntry
...
import com.goldensystem.auris.data.database.AiUsageEntity
...
import com.goldensystem.auris.data.preferences.AlbumArtColorAccuracy
import com.goldensystem.auris.data.preferences.AlbumArtPaletteStyle
import com.goldensystem.auris.data.preferences.AppLanguage
import com.goldensystem.auris.data.preferences.CollagePattern
...
import com.goldensystem.auris.data.repository.LyricsRepository
...
import com.goldensystem.auris.data.ai.GeminiModel
import com.goldensystem.auris.data.ai.provider.AiClientFactory
import com.goldensystem.auris.data.ai.provider.AiProvider
import com.goldensystem.auris.data.preferences.LaunchTab
import com.goldensystem.auris.data.model.Song
import com.goldensystem.auris.data.service.player.HiFiCapabilityChecker
...
class SettingsViewModel @Inject constructor(
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                val models = modelStrings
                    ...
                    .distinct()
                    .map { com.goldensystem.auris.data.ai.GeminiModel(it, formatModelDisplayName(it)) }
    ...
    fun setAlbumArtCacheLimitMb(limitMb: Int) {
        viewModelScope.launch {
            ...
            com.goldensystem.auris.utils.AlbumArtCacheManager.configuredCacheLimitMb = limitMb.toLong()
        }
    }
