...
import com.goldensystem.auris.data.database.AlbumArtThemeEntity
import com.goldensystem.auris.data.database.StoredColorSchemeValues
import com.goldensystem.auris.data.database.toComposeColor
import com.goldensystem.auris.utils.LocalArtworkUri
import com.goldensystem.auris.ui.theme.clearExtractedColorCache
import com.goldensystem.auris.ui.theme.extractSeedColor
        ...
        try {
            ...
            val schemePair = withContext(Dispatchers.Default) {
                val seed = extractSeedColor(
                    bitmap = bitmap,
                    config = com.goldensystem.auris.ui.theme.ColorExtractionConfig(
