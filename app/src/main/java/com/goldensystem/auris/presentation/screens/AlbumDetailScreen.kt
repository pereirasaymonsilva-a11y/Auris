...
import com.goldensystem.auris.presentation.viewmodel.AlbumDetailViewModel
...
private fun CollapsingAlbumTopBar(
    ...
    val surfaceColor = MaterialTheme.colorScheme.surface
    val statusBarColor =
        if (LocalAurisDarkTheme.current) Color.Black.copy(alpha = 0.6f) else Color.White.copy(
            alpha = 0.4f
        )
