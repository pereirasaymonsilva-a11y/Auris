...
import com.goldensystem.auris.presentation.viewmodel.ThemeStateHolder
...
import com.goldensystem.auris.utils.MediaMetadataRetrieverPool
...
class PixelPlayApplication : Application(), ImageLoaderFactory, Configuration.Provider {
    ...
    @Inject
    lateinit var telegramCoilFetcherFactory: dagger.Lazy<com.goldensystem.auris.data.image.TelegramCoilFetcher.Factory>

    @Inject
    lateinit var navidromeCoilFetcherFactory: dagger.Lazy<com.goldensystem.auris.data.image.NavidromeCoilFetcher.Factory>

    @Inject
    lateinit var jellyfinCoilFetcherFactory: dagger.Lazy<com.goldensystem.auris.data.image.JellyfinCoilFetcher.Factory>

    @Inject
    lateinit var localArtworkCoilFetcherFactory: dagger.Lazy<com.goldensystem.auris.data.image.LocalArtworkCoilFetcher.Factory>
