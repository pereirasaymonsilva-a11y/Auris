...
import com.goldensystem.auris.data.database.AiCacheDao
...
import com.goldensystem.auris.data.preferences.dataStore
...
import com.goldensystem.auris.data.network.netease.NeteaseApiService
...
import com.goldensystem.auris.data.repository.LyricsRepositoryImpl
import com.goldensystem.auris.data.repository.MediaStoreSongRepository
import com.goldensystem.auris.data.repository.MusicRepository
import com.goldensystem.auris.data.repository.MusicRepositoryImpl
import com.goldensystem.auris.data.repository.SongRepository
import com.goldensystem.auris.data.repository.TransitionRepository
import com.goldensystem.auris.data.repository.TransitionRepositoryImpl
import com.goldensystem.auris.data.repository.FolderTreeBuilder
...
object AppModule {
    ...
    fun provideSessionToken(@ApplicationContext context: Context): androidx.media3.session.SessionToken {
        return androidx.media3.session.SessionToken(
            context,
            android.content.ComponentName(context, com.goldensystem.auris.data.service.MusicService::class.java)
        )
    }
    ...
    fun provideSongRepository(
        @ApplicationContext context: Context,
        mediaStoreObserver: com.goldensystem.auris.data.observer.MediaStoreObserver,
    ...
    fun provideMusicRepository(
        ...
        telegramDao: com.goldensystem.auris.data.database.TelegramDao,
        telegramCacheManager: Lazy<com.goldensystem.auris.data.telegram.TelegramCacheManager>,
        telegramRepository: Lazy<com.goldensystem.auris.data.telegram.TelegramRepository>,
