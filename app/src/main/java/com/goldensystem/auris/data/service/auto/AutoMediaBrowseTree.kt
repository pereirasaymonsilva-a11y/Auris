package com.goldensystem.auris.data.service.auto
...
class AutoMediaBrowseTree @Inject constructor(
    ...
    companion object {
        ...
        const val CONTEXT_TYPE_EXTRA = "com.goldensystem.auris.auto.extra.CONTEXT_TYPE"
        const val CONTEXT_ID_EXTRA = "com.goldensystem.auris.auto.extra.CONTEXT_ID"
        const val CONTEXT_PARENT_ID_EXTRA = "com.goldensystem.auris.auto.extra.CONTEXT_PARENT_ID"
    ...
    suspend fun getItem(mediaId: String): MediaItem? {
        return when {
            mediaId == ROOT_ID -> buildBrowsableItem(ROOT_ID, "Auris", null, MediaMetadata.MEDIA_TYPE_MUSIC)
