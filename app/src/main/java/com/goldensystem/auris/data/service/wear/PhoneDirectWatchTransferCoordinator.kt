package com.goldensystem.auris.data.service.wear
...
import com.goldensystem.auris.data.navidrome.NavidromeStreamProxy
import com.goldensystem.auris.data.netease.NeteaseStreamProxy
...
import com.goldensystem.auris.data.qqmusic.QqMusicStreamProxy
...
import com.goldensystem.auris.data.telegram.TelegramStreamProxy
...
class PhoneDirectWatchTransferCoordinator @Inject constructor(
    ...
    private val jellyfinStreamProxy: com.goldensystem.auris.data.jellyfin.JellyfinStreamProxy,
    ...
    private suspend fun ensureCloudProxyReady(proxy: Any): Boolean {
        return when (proxy) {
            ...
            is com.goldensystem.auris.data.jellyfin.JellyfinStreamProxy -> proxy.ensureReady(5_000L)
            else -> false
        }
    }
