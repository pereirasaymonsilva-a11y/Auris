...
import com.goldensystem.auris.data.preferences.EqualizerPreferencesRepository
...
import com.goldensystem.auris.data.equalizer.EqualizerManager
import com.goldensystem.auris.data.model.WidgetThemeColors
...
import com.goldensystem.auris.presentation.viewmodel.ColorSchemeProcessor
import androidx.compose.ui.graphics.toArgb
import com.goldensystem.auris.ui.glancewidget.BarWidget4x1
import com.goldensystem.auris.ui.glancewidget.GridWidget2x2
import androidx.compose.material3.dynamicDarkColorScheme
import androidx.compose.material3.dynamicLightColorScheme
import com.goldensystem.auris.data.preferences.ThemePreference
import com.goldensystem.auris.data.service.auto.AutoMediaBrowseTree
import com.goldensystem.auris.data.service.wear.buildWearThemePalette
import com.goldensystem.auris.data.service.wear.WearStatePublisher
import com.goldensystem.auris.presentation.viewmodel.ColorSchemePair
import com.goldensystem.auris.shared.WearIntents
import com.goldensystem.auris.utils.ArtworkTransportSanitizer
...
class MusicService : MediaLibraryService() {
    ...
    @Inject
    lateinit var replayGainManager: com.goldensystem.auris.data.media.ReplayGainManager
    ...
    companion object {
        ...
        const val EXTRA_FORCE_FOREGROUND_ON_START =
            "com.goldensystem.auris.extra.FORCE_FOREGROUND_ON_START"
        ...
        private const val APP_PACKAGE_PREFIX = "com.goldensystem.auris"
...
if (songId != null) {
    ...
    private suspend fun buildPlayerInfo(): PlayerInfo {
        ...
        val queueItems = mutableListOf<com.goldensystem.auris.data.model.QueueItem>()
        ...
        if (!snapshotTimeline.isEmpty) {
            ...
            for (i in startIndex until endIndex) {
                ...
                if (songId != null) {
                    ...
                    queueItems.add(
                        com.goldensystem.auris.data.model.QueueItem(
                            id = songId,
    ...
    private suspend fun loadArtworkBytesForWidget(uri: Uri): ByteArray? {
        ...
        val isLocalArtworkUri = com.goldensystem.auris.utils.LocalArtworkUri.isLocalArtworkUri(uriString)
        return when {
