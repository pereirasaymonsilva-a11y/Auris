...
import com.goldensystem.auris.data.database.SongEngagementEntity
import com.goldensystem.auris.data.database.TransitionDao
import com.goldensystem.auris.data.database.TransitionRuleEntity
import com.goldensystem.auris.data.preferences.PreferenceBackupEntry
    ...
    suspend fun exportToUri(
        ...
        runCatching {
            ...
            reportProgress(
                ...
                detail = "Your Auris backup was created successfully."
            )
        }
    }
