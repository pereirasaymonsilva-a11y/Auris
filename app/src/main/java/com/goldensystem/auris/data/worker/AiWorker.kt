...
import com.goldensystem.auris.data.ai.UserProfileDigestGenerator
...
class AiWorker @AssistedInject constructor(
    ...
    private val preferencesRepo: com.goldensystem.auris.data.preferences.AiPreferencesRepository
