...
interface MusicRepository {
    ...
    fun getPaginatedAlbums(
        ...
        storageFilter: com.goldensystem.auris.data.model.StorageFilter = com.goldensystem.auris.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ...
    suspend fun getFavoriteSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.goldensystem.auris.data.model.SortOption = com.goldensystem.auris.data.model.SortOption.LikedSongTitleAZ,
        storageFilter: com.goldensystem.auris.data.model.StorageFilter = com.goldensystem.auris.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.goldensystem.auris.data.model.SortOption = com.goldensystem.auris.data.model.SortOption.SongDefaultOrder,
        storageFilter: com.goldensystem.auris.data.model.StorageFilter = com.goldensystem.auris.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getAlbumsPage(
        limit: Int,
        offset: Int,
        sortOption: com.goldensystem.auris.data.model.SortOption = com.goldensystem.auris.data.model.SortOption.AlbumTitleAZ,
        storageFilter: com.goldensystem.auris.data.model.StorageFilter = com.goldensystem.auris.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ): List<Album>
    ...
    suspend fun getArtistsPage(
        limit: Int,
        offset: Int,
        sortOption: com.goldensystem.auris.data.model.SortOption = com.goldensystem.auris.data.model.SortOption.ArtistNameAZ,
        storageFilter: com.goldensystem.auris.data.model.StorageFilter = com.goldensystem.auris.data.model.StorageFilter.ALL
    ): List<Artist>
    ...
    fun getMusicFolders(
        storageFilter: com.goldensystem.auris.data.model.StorageFilter = com.goldensystem.auris.data.model.StorageFilter.ALL
    ): Flow<List<com.goldensystem.auris.data.model.MusicFolder>>
