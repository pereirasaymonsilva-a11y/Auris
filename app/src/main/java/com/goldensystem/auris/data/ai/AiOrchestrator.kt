...
import com.goldensystem.auris.data.database.AiCacheEntity
...
import com.goldensystem.auris.di.AppScope
...
class AiOrchestrator @Inject constructor(
    ...
    private suspend fun generateWithRecovery(
        ...
        return try {
            ...
            throw com.goldensystem.auris.data.ai.provider.AiProviderSupport.createException(
            ...
            val failure = com.goldensystem.auris.data.ai.provider.AiProviderSupport.wrapThrowable(
    ...
    private suspend fun recoverModelIfNeeded(
        ...
        client: com.goldensystem.auris.data.ai.provider.AiClient,
        failure: com.goldensystem.auris.data.ai.provider.AiProviderException
    ): String? {
        ...
        val recoveredModel = com.goldensystem.auris.data.ai.provider.AiProviderSupport.selectRecoveryModel(
    ...
    suspend fun generateContent(
        ...
        val providersToTry = com.goldensystem.auris.data.ai.provider.AiProviderSupport.buildProviderChain(userProvider)
        ...
        for (provider in providersToTry) {
            ...
            try {
                ...
                val failure = com.goldensystem.auris.data.ai.provider.AiProviderSupport.wrapThrowable(provider.displayName, e)
