package com.goldensystem.auris.data.network.qqmusic
...
class QqMusicApiService @Inject constructor(
    ...
    private val okHttpClient: OkHttpClient = baseOkHttpClient.newBuilder()
        ...
        .addInterceptor(com.goldensystem.auris.data.remote.qqmusic.QQMusicEncryptInterceptor(
            com.goldensystem.auris.data.remote.qqmusic.QQSignGenerator(context)
        ))
